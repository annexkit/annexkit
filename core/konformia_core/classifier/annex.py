"""Singleton loader for the EU Annex III rule pack (`rules/eu/annex_iii.json`).
...
# The EU rule pack lives at konformia_core/rules/eu/annex_iii.json — i.e. the
# package root (parents[1] of classifier/annex.py), then rules/eu/.
_ANNEX_PATH = Path(__file__).resolve().parents[1] / "rules" / "eu" / "annex_iii.json"
